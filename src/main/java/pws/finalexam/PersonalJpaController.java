...
import pws.finalexam.exceptions.NonexistentEntityException;
import pws.finalexam.exceptions.PreexistingEntityException;
...
public class PersonalJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws_finalexam_jar_0.0.1-SNAPSHOTPU");
